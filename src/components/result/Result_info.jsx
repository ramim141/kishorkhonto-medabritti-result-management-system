      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border-2 border-emerald-200 overflow-hidden">
          ...
          <div className="px-8 py-12 md:py-16">
            {/* Announcement Box */}
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-200 rounded-2xl p-8 md:p-10 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-2xl p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-2 font-semibold">তারিখ</p>
                <p className="text-2xl md:text-3xl font-bold text-gray-900">১৩ ডিসেম্বর ২০২৫</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-2 font-semibold">সময়</p>
                <p className="text-2xl md:text-3xl font-bold text-gray-900">সকাল ১১:০০ টা</p>
              </div>
            </div>

            {/* Note */}
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-orange-500 rounded-lg p-6">
          ...
          {/* Footer */}
          <div className="bg-gradient-to-r from-gray-50 to-slate-50 px-8 py-6 border-t-2 border-gray-200">
