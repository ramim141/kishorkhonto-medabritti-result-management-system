      ...
      <div className="container px-4 mx-auto">
        <div className="relative max-w-7xl mx-auto overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-r from-emerald-600 via-teal-500 to-cyan-600">
          ...
          <div className="relative z-10 px-8 py-16 text-center md:px-16">
            ...
            <button className="px-8 py-4 text-lg font-bold text-emerald-700 transition-transform transform bg-white rounded-full shadow-lg hover:scale-105 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
