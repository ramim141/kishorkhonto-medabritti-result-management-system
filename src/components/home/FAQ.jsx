...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "আবেদন ফি মাত্র ১০০ টাকা। আপনি আমাদের নির্দিষ্ট বিকাশ/নগদ নম্বরে পেমেন্ট করতে পারবেন অথবা সরাসরি আমাদের অফিস থেকে ফর্ম সংগ্রহের সময় নগদ পরিশোধ করতে পারবেন। অনলাইন রেজিস্ট্রেশনের ক্ষেত্রে পেমেন্ট স্লিপ আপলোড করতে হবে।",
